...
export default defineComponent({
    ...
    setup() {
        ...
        const getData = async () => {
            ...
            formData.value.qrCodeContentIsEnabled = ($('//content/qrCodeContent').attr('isEnable') as string).bool()
            formData.value.showApp = $('//content/showApp').text().bool()
            formData.value.showGDPR = $('//content/showGDPR').text().bool()
