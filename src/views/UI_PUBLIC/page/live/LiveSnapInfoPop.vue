 ...
 * @LastEditTime: 2024-07-29 17:13:04
-->
<template>
    <el-dialog
        ...
        <div>
            <div class="info">
                ...
                <div class="row">
                    ...
                    <span>{{ displayTime(current.detect_time) }}</span>
            ...
            <div class="snap">
                ...
                <div>
                    ...
                    <div class="panorama">
                        <img
                            :src="displayBase64Img(current.scene_pic)"
                            class="panorama-img"
                        />
                        <canvas
                            ref="canvas"
...
<script lang="ts" src="./LiveSnapInfoPop.v.ts"></script>
