                            ...
                            >
                                <div class="right">
                                    ...
                                    >
                                        ...
                                        <!-- 云台 -->
                                        <div v-if="pageData.chlData.supportAutoTrack">
                                            <div class="form_span">
                                                <el-divider direction="vertical"></el-divider>
                    ...
                    <div v-if="!pageData.notSupportTipShow">
                        ...
                        <div class="left">
                            ...
                            >
                                ...
                                <span id="draw_tip">{{
                                    peaData.areaCfgData[peaData.activity_type].regulation ? Translate('IDCS_DRAW_RECT_TIP') : Translate('IDCS_DRAW_AREA_TIP').formatForLang(6)
                                }}</span>
                            </div>
                        </div>
                        <!-- 三种功能 -->
