...
export const OCX_Plugin_Load_Lang: Record<string, Record<string, string>> = {
    ...
    '0x0804': {
        ...
        IDCS_NPAPI_NOT_SUPPORT:
            'NPAPI插件已禁用，请进行如下设置来启用：<ul><li>1.在地址栏输入"chrome://flags/#enable-npapi"；</li><li>2.点击"启用NPAPI"下的启用按钮；</li><li>3.关闭所有Chrome；</li><li>4.重新打开Chrome并访问本系统，插件即可使用。</li></ul>或者插件没有安装，请点击<a href=\'%1\'>这里</a>下载并安装插件。 安装时请关闭浏览器！',
    ...
    '0x0404': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            '外掛程式沒有安裝，請按一下<a href=\'%1\'>這裡</a>下載並安裝外掛程式。安裝時請關閉瀏覽器！<br/>如果您已安裝了外掛程式，請在"Safari->偏好設定->安全性"檢查外掛程式是否被禁用。',
        IDCS_NPAPI_NOT_SUPPORT:
            'NPAPI外掛程式已禁用，請進行如下設定來啟用：<ul><li>1.在位址欄輸入"chrome://flags/#enable-npapi"；</li><li>2.按一下"啟用NPAPI"下的啟用按鈕；</li><li>3.關閉所有Chrome；</li><li>4.重新打開Chrome並存取本系統，外掛程式即可使用。</li></ul>或者外掛程式沒有安裝，請按一下<a href=\'%1\'>此處</a>下載並安裝外掛程式。安裝時請關閉瀏覽器！',
    ...
    '0x041a': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Plugin nije instaliran, kliknite <a href=\'%1\'>Here</a> za preuzimanje i instalaciju.Prije instalacije zatvorite pretraživač.<br/>Ako ste instalirali plugin, provjerite dali je onemogućen u "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0405': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Není nainstalován plugin, klikněte <a href=\'%1\'>ZDE</a> pro stažení a nainstalování.  Před instalací pluginu je nutné nejprve zavřít prohlížeč.<br/>Pokud máte plugin již nainstalován, tak prosím zkontrolujte zda není zakázán v nastavení zabezpečení  "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Váš prohlížeč tento plugin nepodporuje, použijte prosím následující prohlížeč: IE10-11, Firefox53 nebo novější, Chrome57 nebo novější, Opera44 nebo novější, Edge16 nebo později.',
    ...
    '0x0429': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'را بررسي کنيد "Safari->Preferences->Security" غير فعال است لطفا plugin را نصب شده داريد, در صورتي که plugin<br/> کليک کنيد. قبل از نصب, لطفا مرورگر خود را ببنديد.اگر شما </a> اينجا <a href=\'%1\'> نصب نشده است, لطفا براي دانلود و نصب plugin',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0407': {
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Ihr Browser unterstützt dieses Plugin nicht, bitte verwenden Sie folgenden Browser: IE10-11, Firefox53 oder höher, Chrome57 oder höher, Opera44 oder höher, Edge16 oder später.',
    ...
    '0x0408': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Το πρόσθετο δεν έχει εγκατασταθεί, κάνετε click <a href=\'%1\'>εδώ</a> για μεταφόρτωση και εγκατάσταση. Πριν την εγκατάσταση κλείστε το φυλλομετρητή<br/>Αν έχετε εγκαταστήσει το πρόσθετο,ελέγξτε αν έχει απενεργοποιηθεί στο μενού "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Το πρόγραμμα περιήγησης σας δεν υποστηρίζει αυτό το πρόσθετο, παρακαλούμε χρησιμοποιήστε το ακόλουθο πρόγραμμα περιήγησης: ή νεότερο, ή νεότερο, ή Opera44 ή νεότερο, Εντζέ16 ή αργότερα.',
    ...
    '0x040d': {
        ...
        IDCS_OTHER_VERSION_WARNING:
            'הדחוף שלך לא תומך בתוספת זו. אנא השתמש בדחופים הבאים: ie10- 11, Firefox 53 או מאוחר יותר, chrome 57 או מאוחר יותר, Safari 11 או מאוחר יותר, אופרה 44 או מאוחר יותר, edge16 או מאוחר יותר.',
    ...
    '0x040e': {
        ...
        IDCS_OTHER_VERSION_WARNING:
            'A böngészője nem támogatja ezt a beépülő modult, használja a következő böngészőket: ie10-11, Firefox 53 vagy újabb, Chrome 57 vagy újabb, Safari 11 vagy újabb, opera 44 vagy újabb, edge16 vagy újabb.',
    ...
    '0x0410': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            "Il plugin non è installato, cliccate <a href='%1'> qui </a> per scaricare e installare. Prima dell'installazione, si prega di chiudere il browser. <br/> Se è stato installato, si prega di verificare se il plugin è disabilitato \"Safari->Preferences->Security\".",
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Utilizzare i seguenti browser: ie10-11, Firefox 53 o versioni successive, chrome 57 o versioni successive, Safari 11 o versioni successive, opera 44 o versioni successive, edge16 o versioni successive.',
    ...
    '0x042f': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Не е инсталиран plugin , кликнете на <a href=\'%1\'>Овде</a> за да го симнете и инсталирате. Пред инсталацијата треба да го исклучите вашиот пребарувач. <br/>Ако имате инсталиран plugin,проверете дали тој е оневозможен во "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Вашиот прелистувач не го поддржува овој приклучок. Ве молиме користете ги следните прелистувачи: ie10- 11, Firefox 53 или подоцна, chrome 57 или подоцна, Safari 11 или подоцна, опера 44 или подоцна, edge 16 или подоцна.',
    ...
    '0x0415': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Plugin nie jest zainstalowany, kliknij <a href=\'%1\'> Here </a>, aby pobrać i zainstalować. Przed instalacją należy zamknąć przeglądarkę. <br/> Jeśli masz zainstalowaną wtyczkę, sprawdź, czy wtyczka jest wyłączona w "Safari-> Preferences-> Security".',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0816': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'O plugin não está instalado, por favor clique <a href=\'%1\'>aqui</a> para baixar e instalar. Antes da instalação por favor feche o seu browser.<br/>Se você possui o plugin, por favor veja se o plugin está desabilitado em "Safari->Preferências->Segurança".',
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Por favor, utilize os seguintes navegadores: ie10-11, Firefox 53 ou posterior, chrome 57 ou posterior, Safari 11 ou posterior, opera 44 ou posterior, edge16 ou posterior.',
    ...
    '0x0418': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Plugin neinstalat, apasati <a href=\'%1\'>Here</a> pt descarcare si instalare inchideti browser  <br/>If you have installed plugin, please check if the plugin is disabled at "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0419': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Плагин не установлен, пожалуйста нажмите <a href=\'%1\'>Сюда</a>, чтобы скачать и установить. Перед установкой закройте браузер.<br/>Если вы уже установили плагин, проверите "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Этот модуль не поддерживается вашим браузером. Используйте следующие версии: IE10 - 11, Firefox53 или выше, Chrome57 или выше, Safari11 или выше, Opera44 или выше, Edge16 или выше.',
    ...
    '0x0424': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Dodatek ni inštaliran, klikni na <a href=\'%1\'>Here</a> za prevzem in inštalacijo. Pred inštalacijo zaprite brskalnik. <br/> Če ste inštalirali dodatek, preverite, če je dodatek onemogočen v  "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0c0a': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            "El plugin no está instalado, haga clic <a href='%1'> aquí </A> para descargar e instalar. Antes de la instalación, por favor cierre su navegador. <br/> Si usted tiene el plug-in, por favor ver si el plugin está deshabilitado en Safari-> Preferencias> Seguridad.",
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            'Su navegador no soporta este plug - in. Utilice los siguientes navegadores: ie10 - 11, Firefox 53 o más tarde, Chrome 57 o más tarde, Safari 11 o más tarde, opera 44 o más tarde, Edge 16 o más tarde.',
    ...
    '0x0412': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            '플러그인이 설치되어 있지 않습니다, 여기를 <a href=\'%1\'>클릭</a> 하여 다운로드 후 설치 하세요. 설치 전 모든 창을 닫으세요.<br/>만약 플러그인이 설치되어 있다면, "Safari->Preferences->Security" 에서 플러그인이 비 활성화 되어 있는지 확인하세요.',
        IDCS_NPAPI_NOT_SUPPORT:
            "NPAPI 가 현재 비 활성화 되어 있습니다. 다음과 설명에 따라 활성화 하십시오:<ul><li>1.주소창에 \"chrome://flags/#enable-npapi\" 입력하세요;</li><li>2.'Enable Npapi'아래에 있는'Enable'을 클릭하세요;</li><li>3.창을 닫으세요;</li><li>4.창을 다시 실행 후 시스템창을 여세요, 플러그인이 이용 가능합니다.</li></ul>만약 플러그인이 설치되어 있지 않다면, 여기를 <a href='%1'>클릭</a> 하여 다운로드후 설치 하세요, 설치 전 모든 창을 닫으세요.",
    ...
    '0x040c': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            "Le plugin n'étant pas installé, veuillez cliquer sur <a href='%1'> ici </a> pour le téléchargement et l'installation. Avant de l'installation, veuillez fermer le navigateur! <br/> Si vous avez installé le plugin, merci de vérifier si le plugin est désactivé sur \"Safari->Préférences->Sécurité\".",
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            "Ce plugin n'est pas pris en charge par votre navigateur, utilisez les navigateurs suivants: IE10 - 11, Firefox 53 ou plus tard, chrome57 ou plus tard, Safari 11 ou plus tard, opera44 ou plus tard, edge16 ou plus tard.",
    ...
    '0x0411': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'このプラグインはインストールされていません。 <a href=\'%1\'>こちら</a> をクリックしてダウンロードとインストールを行って下さい。インストール前にブラウザを閉じてください。<br/>プラグインをインストールする場合は、 "サファリ->優先->セキュリティ"でプラグインが無効かどうか確認して下さい。',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0402': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Добавката не е инсталирана. Моля кликнете <a href=\'%1\'>тук</a> за да я свалите и инсталирате. Преди инсталацията, моля затворете браузъра. Ако сте инсталирали добавката, моля проверете дали не е забранена в "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0c1a': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Priključak nije instaliran, molim kliknite <a href=\'%1\'>Here</a> za preuzimanje i instalaciju. Pre instalacije, molim zatvorite svoj pretraživač.<br/>Ako ste instalirali priključak, molim proverite da li je priključak onemogućen u "Safari->Preferences->Security".',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0436': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Die sagteware is nie geinstalleer, kliek asb op die volgende skakel (  <a href=\'%1\'>Here</a>)om die sagteware af te laai en te installeer, maak asb  seker alle webtuistes toe voor installasie, Wanneer u die sagteware geinstalleer het, maak asb seker dat dat die sagteware ge deaktifeer is by ("Safari->Preferences->Security")',
        IDCS_NPAPI_NOT_SUPPORT:
    ...
    '0x0413': {
        ...
        IDCS_NO_PLUGIN_FOR_MAC:
            'Plagin o‘rnatilmagan. Uni yuklab olish va o‘rnatish uchun quyidagini bosing <a href=\'%1\'>here</a>. O‘rnatishdan oldin brauzerni yoping. .<br/> Agar sizda o‘rnatilgan plagin bo‘lsa, uni "Safari->Preferences->Security ("Safari->Sozlamalar->Xavfsizlik") bo‘limiga ulanganligini tekshirib ko‘ring.',
        IDCS_NPAPI_NOT_SUPPORT:
        ...
        IDCS_OTHER_VERSION_WARNING:
            "Sizning brauzeringiz ushbu plaginni qo'llab-quvvatlamaydi, quyidagi brauzerlardan foydalaning: IE10-11, Firefox53 yoki undan yuqori versiyalardan foydalaning, Safari57 yoki undan yuqori versiyalar, Opera44 yoki undan yuqori versiyalar, EFS44 yoki undan yuqori versiyalar.",
